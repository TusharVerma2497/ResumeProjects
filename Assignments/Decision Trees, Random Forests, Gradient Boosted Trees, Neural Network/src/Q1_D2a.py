...
file=open(sys.argv[4]+'/2_a.txt', 'w')
tracemalloc.start()
...
for i in list(vocab.keys())[10000:]:
    STOPWORDS.add(i)
vocab=list(vocab.keys())[0:10000]
...
file.close()
# 5000
# Training accuracy: 99.88751904205193
# Testing accuracy: 57.23918266992009
# Validation accuracy: 57.497102169233315