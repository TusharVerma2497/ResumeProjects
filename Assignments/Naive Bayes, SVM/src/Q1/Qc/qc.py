...
def test(loc,models=[],targetMethod=0):
...
# res=test(loc=[os.path.join(trainDataDir,'pos/'),os.path.join(trainDataDir,'neg/')],models=[negativeTrainPara, positiveTrainPara],targetMethod=1)
# accuracy=(res[0][0]+res[1][1])*100/(res[0][0]+res[1][1]+res[0][1]+res[1][0])
# print("Training Data Accuracy: {}".format(accuracy))
# accuracy of test data
res=test(loc=[os.path.join(testDataDir,'pos/'),os.path.join(testDataDir,'neg/')],models=[negativeTrainPara, positiveTrainPara],targetMethod=0)
# accuracy=(res[0][0]+res[1][1])*100/(res[0][0]+res[1][1]+res[0][1]+res[1][0])
print("Test Data Confusion Matrix: \n{}".format(res))

res=test(loc=[os.path.join(testDataDir,'pos/'),os.path.join(testDataDir,'neg/')],models=[negativeTrainPara, positiveTrainPara],targetMethod=1)
# accuracy=(res[0][0]+res[1][1])*100/(res[0][0]+res[1][1]+res[0][1]+res[1][0])
print("Test Data Confusion Matrix random guessing: \n{}".format(res))

res=test(loc=[os.path.join(testDataDir,'pos/'),os.path.join(testDataDir,'neg/')],models=[negativeTrainPara, positiveTrainPara],targetMethod=2)
# accuracy=(res[0][0]+res[1][1])*100/(res[0][0]+res[1][1]+res[0][1]+res[1][0])
print("Test Data Confusion Matrix predicting each sample as positive: \n{}".format(res))
